...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1269: (x0,x1) => x0.writeText(x1),
      _1280: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1288: Date.now,
      _1290: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1291: s => {
      ...
      _1293: () => typeof dartUseDateNowForTicks !== "undefined",
      _1294: () => 1000 * performance.now(),
      _1295: () => Date.now(),
      _1298: () => new WeakMap(),
      _1299: (map, o) => map.get(o),
      _1300: (map, o, v) => map.set(o, v),
      _1301: x0 => new WeakRef(x0),
      _1302: x0 => x0.deref(),
      _1308: () => globalThis.WeakRef,
      _1313: s => JSON.stringify(s),
      _1314: s => printToConsole(s),
      _1315: (o, p, r) => o.replaceAll(p, () => r),
      _1317: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1318: s => s.toUpperCase(),
      _1319: s => s.trim(),
      _1320: s => s.trimLeft(),
      _1321: s => s.trimRight(),
      _1322: (string, times) => string.repeat(times),
      _1323: Function.prototype.call.bind(String.prototype.indexOf),
      _1324: (s, p, i) => s.lastIndexOf(p, i),
      _1325: (string, token) => string.split(token),
      _1326: Object.is,
      _1331: a => a.pop(),
      ...
      _1339: (a, i) => a[i],
      _1340: (a, i, v) => a[i] = v,
      _1342: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1343: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1344: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1345: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1346: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1347: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1348: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1349: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1351: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1352: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1353: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1354: (t, s) => t.set(s),
      _1356: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1358: o => o.buffer,
      _1359: o => o.byteOffset,
      _1360: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1361: (b, o) => new DataView(b, o),
      _1362: (b, o, l) => new DataView(b, o, l),
      _1363: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1364: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1365: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1366: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1367: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1368: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1369: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1370: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1371: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1372: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1373: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1374: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1377: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1378: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1379: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1380: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1381: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1382: Function.prototype.call.bind(DataView.prototype.setFloat64),
      ...
      _1401: (handle) => clearTimeout(handle),
      _1404: (c) =>
      ...
      _3442: x0 => x0.navigator,
      _3810: x0 => x0.clipboard,
      _3831: x0 => x0.userAgent,
...
"_children",
"max",
"© 2024 | Developed with ❤️ by Ferry using Flutter",
"clip",
"TextOverflow.",
"VerticalDirection.",
"MainAxisSize.",
...
"hide",
"kurniawan.ferry.rach@gmail.com",
"https://www.linkedin.com/in/kurniawanferry/",
"https://github.com/ferrykurniawan28",
"Feel free to reach out to me if you're looking for a developer, have a question, or just want to connect.",
...
"MQTT",
"REST API",
"Developing a smart medicine reminder using ESP32. The device will remind the user to take their medicine at the right time, helps user to manage their medication storage, track their medication history, and notify the user when the medicine is running low.",
"assets/images/projects/minder-v1.png",
"Smart Medicine Dispenser",
"https://github.com/ferrykurniawan28/smart_medicine_dispenser_esp32",
"Bluetooth",
"Developing an IoT-based web application for pre-diagnosis healthcare assistance.",
"assets/images/projects/triana-iot.png",
"Triana IoT",
"https://github.com/TrianaAI/triana-hw",
"ATmega328P",
"Developing a medicine reminder using ATmega328P. The device will remind the user to take their medicine at the right time and helps user to manage their medication storage.",
"assets/images/projects/micon.png",
"Medicine Reminder",
"https://github.com/ferrykurniawan28/Medicine_Reminder",
"Dart",
"Bloc",
"Git",
"An IoT-based web application for pre-diagnosis healthcare assistance. Built during a hackathon, Triana AI connects web interface with IoT devices to provide intelligent health monitoring and preliminary diagnostic support.",
"assets/images/projects/triana.png",
"Triana",
"A web application for calculating faraidh (inheritance distribution) based on Islamic law. This project helps users understand and calculate the distribution of inheritance shares among heirs.",
"assets/images/projects/faraidh-calculator.png",
"Faraidh Calculator",
"https://github.com/ferrykurniawan28/faraidh_calculator",
"cover",
"Project Link",
...
"Go",
"Push Notifications",
"Developing an IoT medicine dispenser application that controls medication reminders, provides parental monitoring for medication compliance, manages connected devices, and includes doctor appointment scheduling features.",
"assets/images/projects/medicine-reminder.png",
"MINDER App (Medicine Reminder) v2",
"PHP",
"GetX",
"Developing an IoT medicine dispenser application that controls medication reminders and manages medicine storage.",
"assets/images/projects/minder-mobile-v1.png",
"MINDER App (Medicine Reminder)",
"Developing BNEC's mobile application to provide information about BNEC's events, classes, partners, articles, and merchandise.",
"assets/images/projects/bnec-mobile.png",
"BNEC's Mobile Application",
"Create an Expense Tracker application to help users manage their expenses.",
"assets/images/projects/expense-tracker.png",
"Expense Tracker",
"https://github.com/ferrykurniawan28/expense_tracker_Getx",
"Flutter Map",
"GetStorage",
"Create a Favorite Places application to help users save their favorite places.",
"assets/images/projects/favorite-place.png",
"Favorite Places",
"https://github.com/ferrykurniawan28/favorite_places_getx_storage",
"_tabController",
"Open Project",
"spaceAround",
"_slideAnimation",
...
"_pageController",
"Skills",
"The skills, tools, and technologies that I'm familiar with:",
"flutter.png",
"dart.png",
"firebase.png",
"laravel.png",
...
"Leading the IT team to develop and maintain the BNEC's website",
"Developing the BNEC's mobile application",
"Managing the BNEC's database",
"Creating training materials for the IT team",
"Providing technical support for the BNEC's events",
"2024 - Present",
"Vice Project Manager of Operational - New Member Recruitment",
"Leading the operational division to handle the online and onsite events",
"Creating the timeline for the recruitment process",
"Ensuring the recruitment process runs smoothly",
"Providing training for the direct marketing",
"2023",
"Staff of Learning Management",
"Managing the BNEC's classes",
"Coordinating with the tutors and the tutees",
"2023 - 2024",
"Quick summary of my recent experiences:",
"About Me",
"As a final-year Computer Engineering student at Bina Nusantara University , I have a deep passion for building scalable backend systems and end-to-end Internet of Things (IoT) solutions. My goal is to leverage technology to solve meaningful, real-world problems.",
"My current focus is on high-performance backend development using Go (Golang) and the Gin framework to build efficient, concurrent APIs and microservices. I also have extensive experience developing full-stack applications with Laravel (PHP) for the backend and crafting intuitive, cross-platform mobile frontends with Flutter.",
"I am actively seeking full-time opportunities where I can contribute my skills in Backend Development, IoT, or Software Engineering. I am always open to connecting with fellow professionals and discussing technology, innovation, or potential collaborations.",
"_animationRight",
"_animationLeft",
